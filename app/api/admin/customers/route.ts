...
export async function GET(request: NextRequest) {
    try {
        ...
        let filteredCustomers = filterCustomers(mockCustomers, search, status, customerType);
        filteredCustomers = sortCustomers(filteredCustomers, sortBy as keyof Customer, sortOrder);
