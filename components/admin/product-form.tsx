  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const productData = {
        ...
        image: formData.images[0] || formData.image, // Set first image as main image
                ...
                >
                  <Field.Root required>
                    ...
                    <NumberInput.Root
                      ...
                      onValueChange={(e) =>
                        setFormData({ ...formData, price: Number(e.value) })
                      }
                      min={0}
                    >
                      <NumberInput.Control />
                  ...
                  <Field.Root required>
                    ...
                    <NumberInput.Root
                      ...
                      onValueChange={(e) =>
                        setFormData({ ...formData, cost: Number(e.value) })
                      }
                      min={0}
                    >
                      <NumberInput.Control />
                  ...
                  <Field.Root required>
                    ...
                    <NumberInput.Root
                      ...
                      onValueChange={(e) =>
                        setFormData({ ...formData, stock: Number(e.value) })
                      }
                      min={0}
                    >
                      <NumberInput.Control />
                ...
                >
                  ...
                  <Field.Root>
                    ...
                    <NumberInput.Root
                      ...
                      onValueChange={(e) =>
                        setFormData({ ...formData, weight: Number(e.value) })
                      }
                      min={0}
                    >
                      <NumberInput.Control />
                ...
                <VStack align="start" gap={4}>
                  ...
                  <HStack justify="space-between" w="100%">
                    ...
                    <Switch.Root
                      ...
                      onCheckedChange={(e) =>
                        setFormData({ ...formData, isFeatured: !!e.checked })
                      }
                      colorPalette="blue"
                    >
                      <Switch.HiddenInput />
                  ...
                  {formData.stock <= formData.minStockLevel && (
                    ...
                    >
                      <Text color="orange.800">
                        Warning: Current stock ({formData.stock}) is at or below
                        the low stock alert level ({formData.minStockLevel})
                      </Text>
                    </Box>
                  )}
                </VStack>
